...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Activities'),
...
class _MyHomePageState extends State<MyHomePage> {
  // final list1=["General","Department"];
  // Icon btn=Icon(Icons.arrow_drop_down);
  // String btn="";
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
         ...
         body:Column(children: [
          TabBar(tabs:[Tab(text:('General'),),Tab(text:"Department")],labelColor: Colors.blue,)
        ,Expanded(
